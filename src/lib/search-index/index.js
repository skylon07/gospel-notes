...
export class SearchIndex {
    ...
    static createFrom(serialized) {
        ...
        try {
            ...
            throw new SearchIndexCreationError(
    ...
    _checkRefType(refName) {
        if (typeof refName !== "string" && typeof refName !== "number") {
            throw new SearchIndexDocumentError(
                `The given reference type (${typeof refName}) is invalid; string expected`
            )
        }
    }
    ...
    _checkFieldType(fieldName) {
        if (typeof fieldName !== "string" && typeof fieldName !== "number") {
            throw new SearchIndexDocumentError(
                `An invalid field type (${fieldName}) was given; string (or number) expected`
            )
        }
    }
}

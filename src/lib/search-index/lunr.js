...
;(function () {
    ...
    lunr.SortedSet.prototype.union = function (otherSet) {
        ...
        for (
            var i = 0, shortSetElements = shortSet.toArray();
    ...
    lunr.Index.prototype.tokenizer = function (fn) {
        var isRegistered =
            fn.label && fn.label in lunr.tokenizer.registeredFunctions
    ...
    lunr.Index.prototype.add = function (doc, emitEvent) {
        ...
        this._fields.forEach(function (field) {
            var fieldTokens = this.pipeline.run(
                this.tokenizerFn(doc[field.name])
            )
    ...
    lunr.stemmer = (function () {
        ...
        var porterStemmer = function porterStemmer(w) {
            var stem, suffix, firstch, fp, re, re2, re3, re4

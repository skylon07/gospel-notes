...
beforeEach(() => {
    ...
    lunrIndex.deleteReference = jest.fn(lunrIndex.deleteReference.bind(lunrIndex))
...
describe("updating node tests", () => {
    ...
    it("updates multiple given nodes in the index", () => {
        const noteBoxTitles = ["first notebox title", "second notebox title", "third notebox title"]
        const noteBoxContents = ["first notebox content", "second notebox content", "third notebox content"]
        const dropBarTitles = ["first dropbar title", "second dropbar title", "third dropbar title"]
